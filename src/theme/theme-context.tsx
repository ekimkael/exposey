...
interface ThemeContextValue {
  /** The user's preference (what the picker shows as selected). */
  mode: ThemeMode;
 ...
 * Add `expo-secure-store`/AsyncStorage in `setMode` + initial state if you
 * need it to survive a restart.
 */
export function ThemeProvider({ children }: { children: ReactNode }) {
  // useColorScheme() may yield 'light' | 'dark' | null | 'unspecified' — collapse to a binary scheme.
