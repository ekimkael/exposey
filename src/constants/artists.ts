export interface Artist {
  ...
  tilt: number;
  /** Name font size when 34 doesn't fit (long names) */
  nameSize?: number;
...
export const ARTISTS: Artist[] = [
  ...
  { name: 'Cigarettes After Sex', bg: '#2E3032', text: '#E6E6E2', tilt: 7, offsetX: -14, nameSize: 26, art: 'band', artColors: ['#9A9A9A', '#3A3A3A'] },
